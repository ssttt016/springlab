...
public class WeatherUtil {
    public static String getWeather1(String loc) throws Exception{
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=USTwm97O01txdCg5lDBO6e5goJcCddVX91mneGXQk%2B1l8s%2Fg5n%2FWrDeg1mvKem7yUkwTsTy9w7ILY23ZfJu%2B5g%3D%3D"); /*Service Key*/
